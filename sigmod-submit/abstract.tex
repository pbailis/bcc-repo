...
might violate invariants are possible. This forms a theoretical basis
for coordination-avoiding database systems that coordinate only when
...
small SQL dialect, application analysis, and a proof-of-concept
database prototype.
\end{abstract}
