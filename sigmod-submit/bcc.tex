...
\usepackage{subfigure, balance,array}

\let\proof\relax
\let\endproof\relax

\usepackage{color, times, mathptmx, amsmath, amssymb, amsthm, verbatim, 
  mdwlist, graphicx, footnote, multirow, xspace, tikz}
...
\title{Consistency without Coordination: When and How}
