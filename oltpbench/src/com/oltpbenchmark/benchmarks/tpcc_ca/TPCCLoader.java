 ...
 ******************************************************************************/
package com.oltpbenchmark.benchmarks.tpcc_ca;
...
import com.oltpbenchmark.benchmarks.tpcc_ca.jdbc.jdbcIO;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.Customer;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.District;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.History;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.Item;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.NewOrder;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.Oorder;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.OrderLine;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.Stock;
import com.oltpbenchmark.benchmarks.tpcc_ca.pojo.Warehouse;
			...
			for (int w = 1; w <= whseKount; w++) {
				...
				for (int d = 1; d <= distWhseKount; d++) {
					...
					for (int c = 1; c <= custDistKount; c++) {
						...
						Timestamp sysdate = new Timestamp(
				...
				for (int d = 1; d <= distWhseKount; d++) {
					...
					for (int c = 1; c <= custDistKount; c++) {
						...
						if (outputFiles == false) {
							...
							Timestamp entry_d = new Timestamp(
									oorder.o_entry_d);
							str = str + entry_d;
							out.println(str);
						}
